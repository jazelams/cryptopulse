...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final favoriteCryptos = ref.watch(favoritesProvider);

    final topColorDark = const Color(0xFF1A1B2F);
    final topColorLight = Theme.of(
      context,
    ...
    // Lógica que filtra la lista si tocaste el botón de favoritos
    final displayedCryptos = currentFilter == 'Favoritos'
        ? allCryptos
              .where((c) => favoriteCryptos.contains(c['symbol']))
              .toList()
        : allCryptos;
